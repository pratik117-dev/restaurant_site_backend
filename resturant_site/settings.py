...
SECRET_KEY = 'django-insecure-oh_*yodj*(_vw#lk5z2un-y517_f+h4)xnm!c8rwp)#2qy&1vy'
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # Prints OTP to logs
